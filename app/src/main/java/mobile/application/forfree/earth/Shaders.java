...
public class Shaders {
	...
	public static int p_cci_temp_an_1y;

	public static final String vsc_cci_temp_an_1y =
			"uniform mat4 uMVPMatrix;   \n" +
					"uniform mat4 uMVMatrix;   	\n" +
					"uniform mat4 uVMatrix;   	\n" +
					"varying mat4 vMVMatrix;   	\n" +
	...
	public static final String fsc_cci_temp_an_1y =
			"precision mediump float;  	\n" +
					"varying vec3 vLightPos;  	\n" +
					"varying vec3 vPosition;	\n" +     // Interpolated position for this fragment.
					"varying vec3 lightVector;	\n" +
	...
	public static int p_cci_oisst_v2;

	public static final String vsc_cci_oisst_v2 =
			"uniform mat4 uMVPMatrix;   \n" +
					"uniform mat4 uMVMatrix;   	\n" +
					"uniform mat4 uVMatrix;   	\n" +
					"varying mat4 vMVMatrix;   	\n" +
	...
	public static final String fsc_cci_oisst_v2 =
			"precision mediump float;  	\n" +
					"varying vec3 vLightPos;  	\n" +
					"varying vec3 vPosition;	\n" +     // Interpolated position for this fragment.
					"varying vec3 lightVector;	\n" +
	...
	public static int p_noaa_aurora_n;

	/* OpenGL */
	// TODO only for 1 light and texture required
	public static final String vsc_noaa_aurora_n =
			"uniform mat4 uMVPMatrix;   \n" +
					"uniform mat4 uMVMatrix;   	\n" +
					"uniform mat4 uVMatrix;   	\n" +
					"varying mat4 vMVMatrix;   	\n" +
					...
					" mat4 m = mat4( \n" +
					//" 1.0, 0.0, 0.0, 0.0, \n" +  	// first column
					" cos(3.1415*(-102.0/180.0)), sin(3.1415*(-102.0/180.0)), 0.0, 0.0, \n" +  	// first column
					" 0.0, 0.0, 1.0, 0.0, \n" +  	// second column
					" -sin(3.1415*(-102.0/180.0)), cos(3.1415*(-102.0/180.0)), 0.0, 0.0, \n" +  	// third column
					//" 0.0, 1.0, 0.0, 0.0, \n" +  	// third column
					" 0.0, 0.0, 0.0, 1.0  \n" +  	// forth column
					" ); \n" +
					// Second rotation
					" mat4 m_2 = mat4( \n" +
					" 1.0, 0.0, 0.0, 0.0, \n" +  	// first column
					" 0.0, cos(3.1415*(-9.0/180.0)), sin(3.1415*(-9.0/180.0)), 0.0, \n" +  	// second column
					" 0.0, -sin(3.1415*(-9.0/180.0)), cos(3.1415*(-9.0/180.0)), 0.0, \n" +  	// third column
					" 0.0, 0.0, 0.0, 1.0  \n" +  	// forth column
					" ); \n" +
					"_vPosition = m_2*m*aPosition;	\n" +

					" 	vTexM[0] = 1.0 - (_vPosition.x+1.0)/2.0; \n" +
					" 	vTexM[1] = 1.0 - (_vPosition.y+1.0)/2.0; \n" +

					" 	vTexM[0] = 0.5 + (vTexM[0] - 0.5)*(1.0 - 0.008); \n" +
					" 	vTexM[1] = 0.5 + (vTexM[1] - 0.5)*(1.0 - 0.008); \n" +

					"}                         \n";


	public static final String fsc_noaa_aurora_n =
			"precision mediump float;  	\n" +
					"varying vec3 vLightPos;  	\n" +
					"varying vec3 vPosition;	\n" +     // Interpolated position for this fragment.
					"varying vec4 _vPosition;	\n" +
					...
					" 		float d = (1.0 - texture2D(uTextures[1], vTex).r)*(1.0 - texture2D(uTextures[1], vTex).g)*texture2D(uTextures[1], vTex).b; \n" +
					// cloudmap
					"		gl_FragColor = texture2D(uTextures[2], _vTexM)*cm*cmT*( 1.0 + 1.0*uLightAmbientColor + 0.9*uLightDiffuseColor * diffuse2 + 0.1*uLightSpecularColor * specC ) "
					// clouds shadow
					+ "						+ clamp(-1.0*vec4(0.4, 0.4, 0.4, 1.0)*cmS "
					// texture
					+ "						+ clamp(1.0 - 0.5*cm, 0.0, 1.0)*texture2D(uTextures[1], vTex) * (uMaterialEmissiveColor + uLightAmbientColor * uMaterialAmbientColor + uLightDiffuseColor * uMaterialDiffuseColor * diffuse  + 0.3*uLightSpecularColor * specW )     "
	...
	public static int p_noaa_aurora_s;

	/* OpenGL */
	// TODO only for 1 light and texture required
	public static final String vsc_noaa_aurora_s =
			"uniform mat4 uMVPMatrix;   \n" +
					"uniform mat4 uMVMatrix;   	\n" +
					"uniform mat4 uVMatrix;   	\n" +
					"varying mat4 vMVMatrix;   	\n" +
					...
					" mat4 m = mat4( \n" +
					//" 1.0, 0.0, 0.0, 0.0, \n" +  	// first column
					" cos(3.1415*(120.0/180.0)), sin(3.1415*(120.0/180.0)), 0.0, 0.0, \n" +  	// first column
					" 0.0, 0.0, -1.0, 0.0, \n" +  	// second column
					" sin(3.1415*(120.0/180.0)), -cos(3.1415*(120.0/180.0)), 0.0, 0.0, \n" +  	// third column
					//" 0.0, 1.0, 0.0, 0.0, \n" +  	// third column
					" 0.0, 0.0, 0.0, 1.0  \n" +  	// forth column
					" ); \n" +
					"_vPosition = m*aPosition;	\n" +
	...
	public static final String fsc_noaa_aurora_s =
			"precision mediump float;  	\n" +
					"varying vec3 vLightPos;  	\n" +
					"varying vec3 vPosition;	\n" +     // Interpolated position for this fragment.
					"varying vec4 _vPosition;	\n" +
